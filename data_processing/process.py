...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_path', help='funtions dic.',default="./dataset/ffmpeg/c_file/")
    parser.add_argument('--start', help='start functions number to parsed', type=int, default=0)
    parser.add_argument('--end', help='end functions number to parsed', type=int, default=27317)
